...
export class Calendar implements ICalendar {
    ...
    async toActiveRecord(): Promise<CalendarRecord> {
        let record = new CalendarRecord();
    ...
    static fromActiveRecord(record: CalendarRecord): Calendar {
        return new Calendar(
    ...
    static fromObject(data: ICalendar): Calendar {
        return new Calendar(
            data.date,
            data.type,
            data.name,
    ...
    static fromJSON(data: string): Calendar {
